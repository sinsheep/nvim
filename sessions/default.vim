...
xmap <silent>  a :execute 'CocCommand actions.open ' . visualmode()
nmap  f <Plug>(cnc-format-selected)
...
noremap <C-T> :silent! Vista finder coc
noremap <C-P> :Files
noremap <C-Up> :res -5
noremap <C-Left> :vertical resize +5
noremap <C-Down> :res +5
...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.config/nvim/plugged/vim-devicons,~/.config/nvim/plugged/vim-indent-guides,~/.config/nvim/plugged/vim-airline,~/.config/nvim/plugged/vim-airline-themes,~/.config/nvim/plugged/vim-startify,~/.config/nvim/plugged/calendar.vim,~/.config/nvim/plugged/vista.vim,~/.config/nvim/plugged/vim-autoformat,~/.config/nvim/plugged/vimspector,~/.config/nvim/plugged/vim-floaterm,~/.config/nvim/plugged/vim-fugitive,~/.config/nvim/plugged/fzf,~/.config/nvim/plugged/fzf.vim,~/.config/nvim/plugged/undotree,~/.config/nvim/plugged/auto-pairs,~/.config/nvim/plugged/vim-commentary,~/.config/nvim/plugged/vim-surround,~/.config/nvim/plugged/vim-easymotion,~/.config/nvim/plugged/tabular,~/.config/nvim/plugged/vim-repeat,~/.config/nvim/plugged/rainbow,~/.config/nvim/plugged/far.vim,~/.config/nvim/plugged/vim-javascript,~/.config/nvim/plugged/vim-snippets,~/.config/nvim/plugged/coc.nvim,~/.config/nvim/plugged/emmet-vim,~/.config/nvim/plugged/markdown-preview.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.config/nvim/plugged/tabular/after,~/.config/nvim/plugged/vim-javascript/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets,~/.config/coc/extensions/node_modules/coc-explorer
set scrolloff=10
set shiftwidth=4
